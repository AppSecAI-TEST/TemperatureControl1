...
public class TemperatureActivity extends Activity {
    ...
    private static final String CUSTOMER_SPECIFIC_ENDPOINT = "a2emk67m3gszl9.iot.us-east-1.amazonaws.com";
    // Cognito pool ID. For this app, pool needs to be unauthenticated pool with
    // AWS IoT permissions.
    private static final String COGNITO_POOL_ID = "us-east-1_hf55tYn7d";
    // Region of AWS IoT
